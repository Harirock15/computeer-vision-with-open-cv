...
# Load the image
image = cv2.imread("C:/Users/Hari Prasad/Pictures/Screenshots/Screenshot_20230202_192521.png")
...
# Create the Laplacian kernel with a negative center coefficient
